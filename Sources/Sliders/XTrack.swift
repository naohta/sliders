...
public typealias XTrack = XHorizontalValueTrack

public struct XHorizontalValueTrack<V, ValueView: View, MaskView: View>: View where V : BinaryFloatingPoint, V.Stride : BinaryFloatingPoint  {
    let value: V
...
extension XHorizontalValueTrack {
...
extension XHorizontalValueTrack where ValueView == Capsule {
...
extension XHorizontalValueTrack where MaskView == Capsule {
...
extension XHorizontalValueTrack where ValueView == Capsule, MaskView == Capsule {
